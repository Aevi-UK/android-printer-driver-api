...
import com.aevi.print.driver.common.service.CommonPrinterDriverService;
import com.aevi.print.model.BasePrinterInfo;

public class DemoPrinterDriverService extends CommonPrinterDriverService {

    private DemoPrinterDriverFactory demoPrinterDriverFactory;
    private AvailablePrinters availablePrinters;

    public DemoPrinterDriverService() {
