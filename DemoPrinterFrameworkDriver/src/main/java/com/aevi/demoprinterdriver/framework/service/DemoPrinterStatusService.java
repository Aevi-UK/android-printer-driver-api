...
import com.aevi.print.driver.common.service.CommonPrinterStatusService;
import com.aevi.print.model.BasePrinterInfo;

public class DemoPrinterStatusService extends CommonPrinterStatusService {

    private DemoPrinterDriverFactory demoPrinterDriverFactory;
    private AvailablePrinters availablePrinters;

    public DemoPrinterStatusService() {
